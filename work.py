#follow this code mahi, fully updated maps size fixed, everything size fixed. also make a git repo plz
from OpenGL.GL import *
from OpenGL.GLUT import *
from OpenGL.GLU import *
import random
# Camera-related variables
camera_pos = (200,0,400)


# camera_pos = (0,200,400)

# camera_pos = (10,0,1000)
...
def showScreen():
    ...
    draw_text(10, 740, f"Current Weapon :{wpn}")
